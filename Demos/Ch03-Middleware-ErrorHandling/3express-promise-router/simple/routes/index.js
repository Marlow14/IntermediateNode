...
/* add new custom error handling */
const errors = require("../errors");


//Replace the following router with e-p-r
...
//In this example,no next is called from Promise catch error 
//Try this URL: http://localhost:3000/no-next-is-okay
router.get("/no-next-is-okay", function (req, res, next) {
